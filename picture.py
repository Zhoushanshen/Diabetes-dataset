...
plt.rcParams['font.sans-serif'] = ['Microsoft YaHei']  # 设置字体为 Microsoft YaHei（微软雅黑）
...
if 'GFR5lev' in df.columns and ('FPG' in df.columns or 'PG2h' in df.columns):
    ...
    plt.xticks(ind, fpg_by_stage.index)
